              ...
              <div className="container my-3">
                <table className="table table-bordered fs-3">
                  <tr>
                    ...
                    <td colSpan={6}>{tsList.playerName}</td>
                  </tr>
                  <tr>
                    <td colSpan={1}>Total Goals: </td>
                    <td colSpan={2}>{tsList.totalGoals}</td>
                    <td colSpan={1}>Rank: </td>
                    <td colSpan={2}>{tsList.rank}</td>
                  </tr>
                  <tr>
                    <td colSpan={1}>Penalties Scored: </td>
                    <td colSpan={2}>{tsList.penaltiesScored}</td>
                    <td colSpan={1}>Penalties Missed: </td>
                    <td colSpan={2}>{tsList.penaltiesMissed}</td>
                  </tr>
                  <tr>
                    <td colSpan={3}>
                      <Link
